...
export default function AppDetailPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-4 bg-white border border-[var(--color-border)] rounded-2xl p-6">
        <h2 className="text-sm font-semibold text-[var(--color-text-primary)] mb-2">Configuration</h2>
        <p className="text-sm text-[var(--color-text-muted)]">Configuration options will appear here in a future update.</p>
      </div>
